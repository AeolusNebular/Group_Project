...
<nav class="navbar" style="z-index: 2; background-color: #363b9e; width: 100%;">           
    ...
    <button class = "btn" style = "float: right; margin-right: 15px; background-color: transparent; "> 
...
<nav id="main" style = "position: relative">
    <div class="sidebar" id="mySidebar"  >
        <ul style="list-style-type: none; width: 30px;">
            ...
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="Pages\City.php">City</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="Pages\Network.php">Network</a>
            </li>
            <li class="nav-item">
